...
The Common Vulnerability Scoring System (CVSS) is a standardised framework for rating the severity of security vulnerabilities, producing a numerical score from 0 to 10 based on a set of exploitability and impact metrics \cite{cvss_v31_spec}.

CVE-2025-23266 carries a \textbf{CVSS v3.1 Base Score of 9.0 (Critical)} \cite{nvd_cve_2025_23266}. The breakdown of the vector string is as follows:
